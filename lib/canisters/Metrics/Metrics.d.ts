...
export interface Frequency { 'n' : bigint, 'period' : Period };
...
export type GetPeriod = { 'Day' : null } |
  { 'Hour' : null } |
  { 'Week' : null } |
  { 'Minute' : null };
...
export interface Metrics {
  ...
  'attributesByPrincipal' : (arg_0: Principal) => Promise<
      Array<GetAttributeDescription>
    >,
...
export type MetricsError = { 'FailedExecution' : null } |
  { 'InvalidId' : null } |
...
export type Period = { 'Day' : null } |
  { 'Hour' : null } |
  { 'Minute' : null };
export type Result = { 'ok' : AttributeId } |
  { 'err' : MetricsError };
export type Result_2 = { 'ok' : AttributeRecord } |
  { 'err' : MetricsError };
